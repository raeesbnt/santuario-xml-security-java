...
import com.regexbyte.pos.utils.generateSignature.jcp.xml.dsig.internal.SignerOutputStream;
import com.regexbyte.pos.utils.generateSignature.xml.security.algorithms.implementations.SignatureBaseRSA.SignatureRSASSAPSS.DigestAlgorithm;
...
public abstract class DOMRSAPSSSignatureMethod extends AbstractDOMSignatureMethod {
        ...
        throws MarshalException
    {
        ...
        } catch (DOMException |  com.regexbyte.pos.utils.generateSignature.xml.security.signature.XMLSignatureException e) {
        ...
        throws MarshalException
    {
        if (paramsElem != null) {
            ...
            } catch ( com.regexbyte.pos.utils.generateSignature.xml.security.signature.XMLSignatureException e) {
