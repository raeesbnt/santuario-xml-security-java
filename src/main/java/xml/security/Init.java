 ...
 * under the License.
 */
package com.regexbyte.pos.utils.generateSignature.xml.security;
...
import  com.regexbyte.pos.utils.generateSignature.xml.security.algorithms.SignatureAlgorithm;
...
import  com.regexbyte.pos.utils.generateSignature.xml.security.utils.I18n;
...
public class Init {
    ...
    public static synchronized void init() {
        ...
        PrivilegedAction<InputStream> action = () -> {
            String cfile = System.getProperty("com.regexbyte.pos.utils.generateSignature.xml.security.resource.config");
            if (cfile == null) {
                return null;
            }
    ...
    private static void dynamicInit() {
        ...
        //
        I18n.init("en", "US");
        Log.e("debug","Registering default algorithms");
    ...
    private static void fileInit(InputStream is) {
        try {
            ...
            if (config == null) {
                Log.e("warning", "Error in reading configuration file - Configuration element not found");
            ...
            for (Node el = config.getFirstChild(); el != null; el = el.getNextSibling()) {
                ...
                if ("CanonicalizationMethods".equals(tag)) {
                    ...
                    for (Element element : list) {
                        ...
                        try {
                            ...
                            Log.e("debug", "Canonicalizer.register({0}, {1})");

                        } catch (ClassNotFoundException e) {
                            Object[] exArgs = { uri, javaClass };
                            Log.e("error", I18n.translate("algorithm.classDoesNotExist"));
                ...
                if ("TransformAlgorithms".equals(tag)) {
                    ...
                    for (Element element : tranElem) {
                        ...
                        try {
                            ...
                            Log.d("debug", "Transform.register({0}, {1})");
                         //   LOG.log(Level.DEBUG, "Transform.register({0}, {1})", uri, javaClass);
                        } catch (ClassNotFoundException e) {
                            Object[] exArgs = { uri, javaClass };

                            Log.e("ERROR", I18n.translate("algorithm.classDoesNotExist", exArgs));
                        } catch (NoClassDefFoundError ex) {
                            Log.w("WARNING", "Not able to found dependencies for algorithm, I'll keep working.");
                ...
                if ("SignatureAlgorithms".equals(tag)) {
                    ...
                    for (Element sigElem : sigElems) {
                        ...
                        try {
                            ...
                            Log.d("DEBUG", "SignatureAlgorithm.register({0}, {1}) "+ uri+" "+ javaClass);
                        } catch (ClassNotFoundException e) {
                            Object[] exArgs = { uri, javaClass };
                            Log.e("ERROR", I18n.translate("algorithm.classDoesNotExist", exArgs));
                        }
                ...
                if ("ResourceResolvers".equals(tag)) {
                    ...
                    for (Element element : resolverElem) {
                        ...
                        if (description != null && description.length() > 0) {
                            Log.d("DEBUG", "Register Resolver: {0}: {1}"+" "+ javaClass+" "+ description);
                        } else {
                            Log.d("DEBUG", "Register Resolver: {0}: For unknown purposes " + javaClass);
                        }
                ...
                if ("PrefixMappings".equals(tag)){
                    Log.d("DEBUG", "Now I try to bind prefixes:");
