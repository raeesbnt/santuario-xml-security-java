...
public class IgnoreAllErrorHandler implements ErrorHandler {
    ...
    private static final boolean warnOnExceptions =
        getProperty("com.regexbyte.pos.utils.generateSignature.xml.security.test.warn.on.exceptions");

    /** Field throwExceptions           */
    private static final boolean throwExceptions =
        getProperty("com.regexbyte.pos.utils.generateSignature.xml.security.test.throw.exceptions");
