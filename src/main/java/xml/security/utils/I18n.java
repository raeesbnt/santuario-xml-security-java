...
public final class I18n {
    ...
    public static final String NOT_INITIALIZED_MSG =
        ...
        + "Call the static method \"com.regexbyte.pos.utils.generateSignature.xml.security.Init.init();\" to do that "
    ...
    public static String getExceptionMessage(String msgID) {
        try {
            ...
            if ( com.regexbyte.pos.utils.generateSignature.xml.security.Init.isInitialized()) {
