 ...
 * under the License.
 */
package com.regexbyte.pos.utils.generateSignature.xml.security.utils;
...
import  com.regexbyte.pos.utils.generateSignature.xml.security.parser.XMLParser;
import  com.regexbyte.pos.utils.generateSignature.xml.security.parser.XMLParserException;
import  com.regexbyte.pos.utils.generateSignature.xml.security.parser.XMLParserImpl;
...
public final class XMLUtils {
    ...
    private static boolean ignoreLineBreaks =
            AccessController.doPrivileged(
                    (PrivilegedAction<Boolean>) () -> Boolean.getBoolean(" com.regexbyte.pos.utils.generateSignature.xml.security.ignoreLineBreaks"));
   ...
   // private static final Logger LOG = System.getLogger(XMLUtils.class.getName());
    ...
    private static XMLParser xmlParserImpl =
            AccessController.doPrivileged(
                    (PrivilegedAction<XMLParser>) () -> {
                        String xmlParserClass = System.getProperty(" com.regexbyte.pos.utils.generateSignature.xml.security.XMLParser");
    ...
    public static String encodeToString(byte[] bytes) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            return new String(android.util.Base64.encodeToString(bytes, android.util.Base64.DEFAULT));
    ...
    public static byte[] decode(byte[] encodedBytes) {
        return    android.util.Base64.decode(encodedBytes, android.util.Base64.DEFAULT);
