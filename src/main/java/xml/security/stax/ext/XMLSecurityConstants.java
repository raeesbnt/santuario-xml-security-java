 ...
 * under the License.
 */
package com.regexbyte.pos.utils.generateSignature.xml.security.stax.ext;
...
public class XMLSecurityConstants {
   ...
   // public static final XMLOutputFactory xmlOutputFactoryNonRepairingNs;
    ...
    private static final String RANDOM_ALGORITHM_KEY = " com.regexbyte.pos.utils.generateSignature.xml.security.securerandom.algorithm";
