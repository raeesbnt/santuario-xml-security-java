...
public abstract class SignatureAlgorithmSpi {
    ...
    /**
     * Proxy method for {@link Signature#getAlgorithm}
     * which is executed on the internal {@link Signature} object.
     *
     * @return the result of the {@link Signature#getAlgorithm} method
     */
    ...
    /**
     * Proxy method for {@link Signature#update(byte[])}
     * which is executed on the internal {@link Signature} object.
     *
     * @param input
    ...
    /**
     * Proxy method for {@link Signature#update(byte[], int, int)}
     * which is executed on the internal {@link Signature} object.
     *
     * @param buf
     * @param offset
    ...
    /**
     * Proxy method for {@link Signature#initSign(PrivateKey)}
     * which is executed on the internal {@link Signature} object.
     *
     * @param signingKey
    ...
    /**
     * Proxy method for {@link Signature#sign()}
     * which is executed on the internal {@link Signature} object.
     *
     * @return the result of the {@link Signature#sign()} method
     * @throws XMLSignatureException
     */
    ...
    /**
     * Proxy method for {@link Signature#verify(byte[])}
     * which is executed on the internal {@link Signature} object.
     *
     * @param signature
    ...
    /**
     * Proxy method for {@link Signature#setParameter(
