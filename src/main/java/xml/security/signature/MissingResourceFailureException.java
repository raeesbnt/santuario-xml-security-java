...
/**
 * Thrown by {@link  com.regexbyte.pos.utils.generateSignature.xml.security.signature.SignedInfo#verify()} when
 * testing the signature fails because of uninitialized
 * {@link  com.regexbyte.pos.utils.generateSignature.xml.security.signature.Reference}s.
 *
...
public class MissingResourceFailureException extends XMLSignatureException {
    ...
    /**
     * used to set the uninitialized {@link  com.regexbyte.pos.utils.generateSignature.xml.security.signature.Reference}
     *
    ...
    /**
     * used to get the uninitialized {@link  com.regexbyte.pos.utils.generateSignature.xml.security.signature.Reference}
     *
     * This allows to supply the correct {@link  com.regexbyte.pos.utils.generateSignature.xml.security.signature.XMLSignatureInput}
     * to the {@link  com.regexbyte.pos.utils.generateSignature.xml.security.signature.Reference} to try again verification.
     *
